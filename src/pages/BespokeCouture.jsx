  ...
  if (submitted) {
    return (
      <div className="page-container container text-center">
        <div className="bespoke-success" style={{ marginTop: '4rem' }}>
        ...
        <form className="bespoke-form" onSubmit={handleSubmit}>
          ...
          <div className="form-step">
            ...
            <div className="form-group">
              ...
              <textarea
                placeholder="Tell us what you love about the inspiration and any changes you'd like (e.g. different neckline)..."
                rows="4"
                value={form.notes}
          ...
          <div className="form-actions text-center mt-lg">
            ...
            <Button variant="primary">Proceed to Payment (40%)</Button>
          </div>
        </form>
      </div>
    </div>
